...
- dataFiltered (dict; optional):
    ...
    http://tabulator.info/docs/5.2/callbacks#filter The dataFiltered
    callback is triggered after the table dataset is filtered.

- dataFiltering (list; optional):
    dataFiltering based on
    http://tabulator.info/docs/5.2/callbacks#filter The dataFiltering
...
- downloadButtonType (dict; optional):
    ...
    type is file type to download e.g.  downloadButtonType = {\"css\":
    \"btn btn-primary\", \"text\":\"Export\", \"type\":\"xlsx\"}.
...
- initialHeaderFilter (list; optional):
    ...
    http://tabulator.info/docs/5.2/filter#header can take array of
    filters.
