...
de = DataEditor(
    ...
    notes_column_required=webapp_config.notes_column_required,
    notes_column_display_name=webapp_config.notes_column_display_name,
    validation_column_required=webapp_config.validation_column_required,
    validation_column_display_name=webapp_config.validation_column_display_name,
