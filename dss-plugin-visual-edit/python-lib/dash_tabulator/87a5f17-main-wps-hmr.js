  ...
  return _createClass(DashTabulator, [{
    ...
    function componentDidMount() {
      ...
      this.tabulator = new tabulator_tables__WEBPACK_IMPORTED_MODULE_3__["TabulatorFull"](this.el, {
        ...
        "movableColumns": true,
        "persistence": true,
        "footerElement": "<button class='tabulator-page' onclick='localStorage.clear(); window.location.reload();'>Reset Viewz</button><p>Debug</p>"
      });
      ...
      this.debugP = document.createElement("p");
      this.debugP.innerHTML = "Debug";
      window.addEventListener('message', function (event) {
        var data = event.data;
        if (data && data.type === 'filters') {
          console.log(data.filters); // the filters
          this.debugP.innerHTML = JSON.stringify(data.filters);
        }
      });
    }
  }, {
...
//# sourceMappingURL=87a5f17-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI4N2E1ZjE3LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==