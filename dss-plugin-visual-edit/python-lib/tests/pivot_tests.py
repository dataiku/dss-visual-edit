...
from commons import replay_edits, apply_edits_from_df, get_dataframe
...
#%% Apply edits from DataFrame
edited_df = apply_edits_from_df(original_ds, edits_df)

#%% Apply edits from dataset
edits_ds = Dataset(original_ds_name + "_edits")
edits_df = get_dataframe(edits_ds)
edited_df = apply_edits_from_df(original_ds, edits_df)
